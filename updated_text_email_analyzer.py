...
def invoke_custom_api(tkd_name: str, input_text: str, system_prompt: str) -> str:
    """
    Invokes the custom API endpoint by sending a JSON payload with three required keys:
    ...
    Debug statements trace the payload and show a snippet of the response.
    ...
    try:
        ...
        response.raise_for_status()  # Raise an error if HTTP error code.
